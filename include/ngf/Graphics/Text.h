...
public:
  ...
  Text(std::wstring string, const ngf::Font &font, unsigned int characterSize = 30);
  ...
  void setFont(const ngf::Font &font);
  /// @brief Gets the text's font.
  /// \return The current text's font.
  const ngf::Font *getFont() const;
  ...
  void showTextBounds(bool textBounds);
